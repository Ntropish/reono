...
export interface GeneratedApiClient {
  ...
  get<T = any>(
    ...
    options: SafeRequestOptions<"/api/v1/users/:id">
  ): Promise<T>;
  put<T = any>(
    path: "/api/v1/users/:id",
    options: SafeRequestOptions<"/api/v1/users/:id">
  ...
  get<T = any>(
    ...
    options: SafeRequestOptions<"/api/v1/organizations/:orgId/users/:userId">
  ): Promise<T>;
}
